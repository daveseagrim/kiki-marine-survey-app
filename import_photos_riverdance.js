...
(async function importRiverdancePhotos() {
  ...
  const SIMPLE_FOLDER_MAP = {
    ...
    'riverdance, deck coachroof and pilot house': ['Deck and coachroof/pilot house photos'],
    'riverdance, deck condition': ['Deck and coachroof/pilot house condition (spider cracks, etc.)'],
    'riverdance, deck conductivity': ['Deck and coachroof/pilot house conductivity testing'],
    'riverdance, deck percussion': ['Deck and coachroof/pilot house impact and resonance testing'],
